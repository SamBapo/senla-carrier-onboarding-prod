...
export const Step4Verification = ({ data, onSubmit, onBack, language = "en" }: Step4Props) => {
  ...
  const translations = {
    en: {
      ...
      truckRegDesc: "Upload minimum 3 photos of truck registration books.",
    ...
    vi: {
      ...
      truckRegDesc: "Tải lên tối thiểu 3 ảnh giấy đăng ký xe (cà vẹt) của 3 phương tiện khác nhau",
